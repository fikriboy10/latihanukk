...
<div class="page-header d-print-none">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a href="#" class="btn btn-primary" id="btnTambahkonsumen">
                    ...
                    <div class="page-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/konsumen" method="GET">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                            <input type="text" name="nama_konsumen" id="nama_konsumen" class="form-control" placeholder="Nama Konsumen" value="{{ Request('nama_konsumen') }}">
                                            </div>
                                        </div>
                    <div class="col-2">
                        <div class="form-group">
    ...
    <div class="row mt-2">
      <div class="col mt-12">
        <div class="card">
          ...
          {{ $konsumen->links('vendor.pagination.bootstrap-5') }}
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal modal-blur fade" id="modal-inputkonsumen" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data Konsumen</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="/konsumen/store" method="POST" id="frmKonsumen" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nama" value="" class="form-control" name="nama" placeholder="Nama Konsumen">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="no_telp" value="" class="form-control" name="no_telp" placeholder="No. Telp">
                            </div>
                        </div>
                    </div>
                    {{-- <div class="row mt-2">
...
<div class="modal modal-blur fade" id="modal-editkonsumen" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<script>
    $(function() {
        $("#btnTambahkonsumen").click(function() {
            $("#modal-inputkonsumen").modal("show");
        });
